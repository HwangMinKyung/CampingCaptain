...
<div id="modify_reivew_form" align="center">
	...
	<form name="formm" id="modify" method="get" action="modifyMyReview">
		<label>Title</label>
		<input type="text" name="title" id="title" value="${RealReviewVO.title}" size="20">
		...
		<textarea rows="8" cols="65" id="content" name="content">${RealReviewVO.content}</textarea>
		<br> 
		...
		<div id="buttons">
			<input type="button" value="수정하기 " form="modify" id="modify1" class="submit" onClick="modify_myreviews()"> 
